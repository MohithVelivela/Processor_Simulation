...
import processor.pipeline.Data_Interlock;
...
public class Processor {
	...
	public Processor()
	{
		...
		data_interlock = new Data_Interlock(this);
		IFUnit = new InstructionFetch(this, IF_EnableLatch, IF_OF_Latch, EX_IF_Latch,data_interlock);
		OFUnit = new OperandFetch(this, IF_OF_Latch, OF_EX_Latch, control_unit,data_interlock,IF_EnableLatch);
		EXUnit = new Execute(this, OF_EX_Latch, EX_MA_Latch, EX_IF_Latch,control_unit,data_interlock,IF_EnableLatch,IF_OF_Latch);
		MAUnit = new MemoryAccess(this, EX_MA_Latch, MA_RW_Latch,control_unit,data_interlock);
		RWUnit = new RegisterWrite(this, MA_RW_Latch, IF_EnableLatch, control_unit,data_interlock);
	}
